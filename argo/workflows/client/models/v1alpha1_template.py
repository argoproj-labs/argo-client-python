...
class V1alpha1Template(object):
    ...
    openapi_types = {
        ...
        'steps': 'list[V1alpha1ParallelSteps]',
    ...
    def steps(self):
        ...
        :rtype: list[V1alpha1ParallelSteps]
        """
        return self._steps
    ...
    def steps(self, steps):
        ...
        :type: list[V1alpha1ParallelSteps]
        """
