...
class WorkflowTemplateServiceApi(object):
    ...
    def create_workflow_template(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param WorkflowtemplateWorkflowTemplateCreateRequest body: (required)
    ...
    def delete_workflow_template(self, namespace, name, **kwargs):  # noqa: E501
        ...
        :return: WorkflowtemplateWorkflowDeleteResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_workflow_template_with_http_info(namespace, name, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_workflow_template_with_http_info(namespace, name, **kwargs)  # noqa: E501
            return data

    def delete_workflow_template_with_http_info(self, namespace, name, **kwargs):  # noqa: E501
        """delete_workflow_template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_workflow_template_with_http_info(namespace, name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_workflow_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params or
                params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `delete_workflow_template`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `delete_workflow_template`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='WorkflowtemplateWorkflowDeleteResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_workflow_template(self, namespace, name, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workflow_template_with_http_info(namespace, name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_workflow_template_with_http_info(namespace, name, **kwargs)  # noqa: E501
            return data

    def get_workflow_template_with_http_info(self, namespace, name, **kwargs):  # noqa: E501
        """get_workflow_template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_template_with_http_info(namespace, name, async_req=True)
        >>> result = thread.get()
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_workflow_template`")  # noqa: E501
    ...
    def lint_workflow_template(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str namespace: (required)
        :param WorkflowtemplateWorkflowTemplateLintRequest body: (required)
        :return: V1alpha1WorkflowTemplate
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.lint_workflow_template_with_http_info(namespace, body, **kwargs)  # noqa: E501
        else:
            (data) = self.lint_workflow_template_with_http_info(namespace, body, **kwargs)  # noqa: E501
            return data

    def lint_workflow_template_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        """lint_workflow_template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lint_workflow_template_with_http_info(namespace, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method lint_workflow_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params or
                params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `lint_workflow_template`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `lint_workflow_template`")  # noqa: E501
    ...
    def list_workflow_templates_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/workflow-templates/{namespace}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_workflow_template(self, namespace, name, body, **kwargs):  # noqa: E501
        ...
        :param str namespace: (required)
        :param str name: (required)
        :param WorkflowtemplateWorkflowTemplateUpdateRequest body: (required)
        :return: V1alpha1WorkflowTemplate
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_workflow_template_with_http_info(namespace, name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_workflow_template_with_http_info(namespace, name, body, **kwargs)  # noqa: E501
            return data

    def update_workflow_template_with_http_info(self, namespace, name, body, **kwargs):  # noqa: E501
        """update_workflow_template  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_workflow_template_with_http_info(namespace, name, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_workflow_template" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params or
                params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `update_workflow_template`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `update_workflow_template`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_workflow_template`")  # noqa: E501
