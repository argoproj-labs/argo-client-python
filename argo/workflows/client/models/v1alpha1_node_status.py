...
class V1alpha1NodeStatus(object):
    ...
    def __init__(self, boundary_id=None, children=None, daemoned=None, display_name=None, finished_at=None, host_node_name=None, id=None, inputs=None, memoization_status=None, message=None, name=None, outbound_nodes=None, outputs=None, phase=None, pod_ip=None, resources_duration=None, started_at=None, stored_template_id=None, synchronization_status=None, template_name=None, template_ref=None, template_scope=None, type=None, workflow_template_name=None, local_vars_configuration=None):  # noqa: E501
