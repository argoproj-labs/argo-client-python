...
class CronWorkflowServiceApi(object):
    ...
    def delete_cron_workflow_with_http_info(self, namespace, name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `name` when calling `delete_cron_workflow`")  # noqa: E501
    ...
    def lint_cron_workflow_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('namespace' not in local_var_params or  # noqa: E501
                                                        local_var_params['namespace'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `namespace` when calling `lint_cron_workflow`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `lint_cron_workflow`")  # noqa: E501
