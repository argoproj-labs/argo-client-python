...
class V1alpha1GitArtifact(object):
    ...
    def __init__(self, depth=None, fetch=None, insecure_ignore_host_key=None, password_secret=None, repo=None, revision=None, ssh_private_key_secret=None, username_secret=None):  # noqa: E501
        """V1alpha1GitArtifact - a model defined in Swagger"""  # noqa: E501
    ...
    def ssh_private_key_secret(self):
        ...
        SSHPrivateKeySecret is the secret selector to the repository ssh private key  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1GitArtifact, dict):
