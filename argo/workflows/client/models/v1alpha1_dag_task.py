...
class V1alpha1DAGTask(object):
    ...
    def __init__(self, arguments=None, continue_on=None, dependencies=None, name=None, on_exit=None, template=None, template_ref=None, when=None, with_items=None, with_param=None, with_sequence=None, local_vars_configuration=None):  # noqa: E501
