...
class V1alpha1WorkflowTemplateUpdateRequest(object):
    ...
    def __init__(self, name=None, namespace=None, template=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1WorkflowTemplateUpdateRequest - a model defined in OpenAPI"""  # noqa: E501
