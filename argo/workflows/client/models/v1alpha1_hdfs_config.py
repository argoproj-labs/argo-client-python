...
class V1alpha1HDFSConfig(object):
    ...
    def __init__(self, addresses=None, hdfs_user=None, krb_c_cache_secret=None, krb_config_config_map=None, krb_keytab_secret=None, krb_realm=None, krb_service_principal_name=None, krb_username=None):  # noqa: E501
