...
class V1alpha1DAGTask(object):
    ...
    def __init__(self, arguments=None, continue_on=None, dependencies=None, name=None, template=None, when=None, with_items=None, with_param=None, with_sequence=None):  # noqa: E501
