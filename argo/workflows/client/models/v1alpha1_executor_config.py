...
class V1alpha1ExecutorConfig(object):
    ...
    def __init__(self, service_account_name=None):  # noqa: E501
        """V1alpha1ExecutorConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1ExecutorConfig, dict):
