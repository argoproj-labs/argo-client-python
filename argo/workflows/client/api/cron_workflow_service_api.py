...
class CronWorkflowServiceApi(object):
    ...
    def create_cron_workflow(self, namespace, body, **kwargs):  # noqa: E501
        ...
        :param CronworkflowCreateCronWorkflowRequest body: (required)
    ...
    def delete_cron_workflow(self, namespace, name, **kwargs):  # noqa: E501
        ...
        :return: CronworkflowCronWorkflowDeletedResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def delete_cron_workflow_with_http_info(self, namespace, name, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CronworkflowCronWorkflowDeletedResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_cron_workflow(self, namespace, name, body, **kwargs):  # noqa: E501
        ...
        :param str namespace: (required)
        :param str name: (required)
        :param CronworkflowUpdateCronWorkflowRequest body: (required)
        :return: V1alpha1CronWorkflow
                 If the method is called asynchronously,
                 returns the request thread.
        """
