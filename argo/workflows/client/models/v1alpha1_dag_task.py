...
class V1alpha1DAGTask(object):
    ...
    def __init__(self, arguments=None, continue_on=None, dependencies=None, depends=None, name=None, on_exit=None, template=None, template_ref=None, when=None, with_items=None, with_param=None, with_sequence=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1DAGTask - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def depends(self):
        """Gets the depends of this V1alpha1DAGTask.  # noqa: E501

        Depends are name of other targets which this depends on  # noqa: E501

        :return: The depends of this V1alpha1DAGTask.  # noqa: E501
        :rtype: str
        """
    ...
    def depends(self, depends):
        """Sets the depends of this V1alpha1DAGTask.
