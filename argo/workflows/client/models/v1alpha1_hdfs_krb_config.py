...
class V1alpha1HDFSKrbConfig(object):
    ...
    def __init__(self, krb_c_cache_secret=None, krb_config_config_map=None, krb_keytab_secret=None, krb_realm=None, krb_service_principal_name=None, krb_username=None):  # noqa: E501
        """V1alpha1HDFSKrbConfig - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1HDFSKrbConfig, dict):
