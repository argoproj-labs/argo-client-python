...
class V1alpha1Prometheus(object):
    ...
    def gauge(self, gauge):
        ...
        :type: V1alpha1Gauge
        """
        if self.local_vars_configuration.client_side_validation and gauge is None:  # noqa: E501
            raise ValueError("Invalid value for `gauge`, must not be `None`")  # noqa: E501
