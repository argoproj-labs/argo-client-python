...
class V1alpha1NodeStatus(object):
    ...
    def __init__(self, boundary_id=None, children=None, daemoned=None, display_name=None, finished_at=None, id=None, inputs=None, message=None, name=None, outbound_nodes=None, outputs=None, phase=None, pod_ip=None, started_at=None, stored_template_id=None, template_name=None, template_ref=None, template_scope=None, type=None, workflow_template_name=None):  # noqa: E501
