...
class V1ConfigMapKeySelector(object):
    ...
    def __init__(self, key=None, local_object_reference=None, optional=None):  # noqa: E501
        """V1ConfigMapKeySelector - a model defined in Swagger"""  # noqa: E501
    ...
    def local_object_reference(self):
        """Gets the local_object_reference of this V1ConfigMapKeySelector.  # noqa: E501

        The ConfigMap to select from.  # noqa: E501

        :return: The local_object_reference of this V1ConfigMapKeySelector.  # noqa: E501
    ...
    def local_object_reference(self, local_object_reference):
        """Sets the local_object_reference of this V1ConfigMapKeySelector.

        The ConfigMap to select from.  # noqa: E501

        :param local_object_reference: The local_object_reference of this V1ConfigMapKeySelector.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ConfigMapKeySelector, dict):
